...
$masterConfig = <<-SCRIPT
    ...
    #
    cp /vagrant/init-files/tiller-rbac.yaml /home/vagrant/
    chown vagrant /home/vagrant/tiller-rbac.yaml

    #
    # Copy initialization script
    #
    cp /vagrant/init-files/init.sh /home/vagrant/
    chmod +x /home/vagrant/init.sh
    chown vagrant /home/vagrant/init.sh

    #
    # Modify vagrant's login script
    #
    cat /vagrant/init-files/add-bashrc.sh | tee -a /home/vagrant/.bashrc
SCRIPT
